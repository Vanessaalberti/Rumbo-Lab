...
/**
 * Vista institucional — los espacios de una organización, juntos. Antes esto
 * era una fila de cuatro KPIs, cuatro barras de progreso y un gráfico de
 * barras de siete meses; ninguno de esos números existía, era con exactitud
 * el dashboard genérico que puede ilustrar cualquier SaaS. Lo que quedó es la
 * única afirmación verdadera de la sección —una institución ve todos sus
 * espacios en un lugar— sostenida con la estructura real de un espacio, sin
 * métricas de impacto: lo que escala no es un tablero, es que cada espacio ya
 * está registrando lo suyo.
 */

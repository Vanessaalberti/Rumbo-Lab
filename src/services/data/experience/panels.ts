...
/**
 * Los paneles a los que la cuenta **ya tiene acceso**.
 *
 * Una cuenta puede tener Aprendiz, Mentor, ambos o ninguno todavía (Notion
 * 02 · Mi Rumbo §3 bis): "estar autenticado" y "tener acceso a un panel" son
 * dos cosas distintas. Esta lista solo contiene experiencias activadas — un
 * panel que la persona no activó no se ofrece como si lo tuviera.
 */
...
/**
 * A dónde entra esta cuenta.
 *
 * Único lugar que decide ese destino: lo usan el guard que aparta de las
 * pantallas de acceso y las llamadas a la acción del Home cuando ya hay
 * sesión. Sin ninguna experiencia activada, `/elegir-experiencia` — nunca se
 * asume Aprendiz.
 */
